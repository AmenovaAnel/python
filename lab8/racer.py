...
background = pygame.image.load('c:\\Users\\USER\\Downloads\\road.png') 
...
class Coin(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('c:\\Users\\USER\\Downloads\\coin.jpg')  # image of coin
...
class Enemy(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('c:\\Users\\USER\\Downloads\\rred.webp')  # image of enemy car
        self.rect = self.image.get_rect()  # rectangle of image
        self.set_random_position()
...
class Player(pygame.sprite.Sprite):  # Player is moving by x-axis. It can collide with coin or enemy car
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('c:\\Users\\USER\\Downloads\\blue.webp')  # image of player
        self.rect = self.image.get_rect()  # rectangle of image
...
while not game_over:  # while game is playing
    ...
    if pygame.sprite.spritecollideany(player, enemies):  # collision with enemy car
        ...
        pygame.mixer.Sound('Lab8_racer_crash.wav').play()  # crash music appears
